...
// import box1 from "../../assets/Box1.mp4";
// import box2 from "../../assets/Box2.mp4";
// import box3 from "../../assets/Box3.mp4";
...
const HeroSection = () => {
  ...
  const handleNext = () => {
    setCurrentIndex((prev) => (prev + 1) % tabs.length);
    setIsMuted(true); // har naye video pe default muted
  };
  ...
  return (
    <section className="bg-white min-h-screen flex flex-col items-center justify-center px-6 lg:px-20 py-16">
      ...
      <div className="relative mt-16 w-full max-w-6xl overflow-hidden">
        ...
        {/* Mute/Unmute button only if video has sound */}
