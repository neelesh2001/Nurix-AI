...
//     <>
//       <motion.section
//         className="min-h-screen bg-white py-16 px-4 sm:px-6 lg:px-8 w-[1100px] ml-52"
...
//                 style={
//                   {
//                     // Making div behave like a form for display purposes
//                   }
//                 }
//               >
//                 {/* Name and Email Row */}
...
//                 {/* Privacy Policy Checkbox - SIMPLE */}
...
//             </div>
//             {/* Contact Info */}
//             <div className="bg-gray-800 rounded-lg p-8 text-white h-fit w-[400px] ml-28 mt-10">
...
//                     Sales Inquiries
//                   </div>
//                   <p className="text-sm">hello@nurix.ai</p>
//                 </div>
...
//                     Partners
//                   </div>
//                   <p className="text-sm">partners@nurix.ai</p>
//                 </div>
//               </div>
//             </div>
//           </div>
